...
class SpinnerTypeButtonTypeAdapter(
  private val mContext: Context,
  @LayoutRes
  private val layoutResource: Int,
  private val allItems: List<SpinnerTypeButtonTypeModel>
) : ArrayAdapter<SpinnerTypeButtonTypeModel>(mContext, layoutResource, allItems) {
